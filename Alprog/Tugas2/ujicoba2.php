 ...
 <script src="https://maps.googleapis.com/maps/api/js?v=3.exp"></script>
  ...
  function initialize() {
	var sites = [
              ...
              <?php
                    $koneksi = mysql_connect('localhost','root','4dm1n54bo');
                    mysqli_select_db($koneksi,'rutegreedy');
...
<body>
 <div class="wrap">
  ...
  <div id="panel">
    <input class="input" id="start" type="text" value="Lapangan Merdeka, ambon">
    <input class="input" id="end" type="text" value="Masjid Raya Al Fatah">
